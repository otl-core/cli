 ...
 *
 * Placeholder commands for future engine scaffolding and site setup.
 */
...
export function registerSetupCommands(program: Command): void {
  ...
  setup
    .command("site")
    .description("Create and configure a new site")
    .action(async () => {
      console.log("Site setup is not yet available.");
      console.log(
        "This command will create a site and generate access tokens.",
      );
      process.exit(1);
    });
}
